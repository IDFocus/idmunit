...
/**
 * Implements an IdMUnit test step for Validate object operations
 * @author Brent Kynaston, Software Engineer, TriVir LLC
 * @version %I%, %G%
 * @see TestStep
 */public class TestStepValidateObject implements TestStep{
	private Connection m_connection;
    private Attributes m_data;
    
	public TestStepValidateObject(Connection idmUnitConnection, Attributes dataRows, LdapOperations ops) {
		m_connection = idmUnitConnection;
		m_data = dataRows;
    }

	public void runStep() throws Exception {
		m_connection.validateObject(m_data);
	}
}
