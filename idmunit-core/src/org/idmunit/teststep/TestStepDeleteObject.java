...
/**
 * Implements an IdMUnit test step for Delete object operations
 * @author Brent Kynaston, Software Engineer, TriVir LLC
 * @version %I%, %G%
 * @see TestStep
 */
public class TestStepDeleteObject implements TestStep{
	private Connection m_connection;
    private Attributes m_data;
    
	public TestStepDeleteObject(Connection idmUnitConnection, Attributes dataRows, LdapOperations ops) {
		m_connection = idmUnitConnection;
		m_data = dataRows;
    }

	public void runStep() throws Exception {
		m_connection.deleteObject(m_data);
	}
}
